...
RAW_TABLE_COLUMNS: dict[str, frozenset[str]] = {
    "raw_contratos": frozenset({
        ...
        "situacao", "tipo_contrato", "num_licitacao", "num_processo", "ano",
        "cnpj_fornecedor", "nome_fornecedor", "valor_inicial", "valor_global",
        "valor_aditivos", "valor_final", "prazo_dias", "data_assinatura",
        "data_inicio_vigencia", "data_fim_vigencia", "data_rescisao", "orgao",
        "secretaria", "unidade_gestora", "qtd_aditivos", "possui_aditivo",
        "coletado_em", "payload_bruto",
    }),
    "raw_licitacoes": frozenset({
        "id", "id_licitacao", "fonte", "municipio_ibge", "ano", "objeto",
        "modalidade", "situacao", "tipo", "numero", "num_processo",
        "valor_estimado", "valor_homologado", "data_abertura", "data_publicacao",
    ...
    "raw_obras_legado": frozenset({
        ...
        "cnpj_executora", "nome_executora", "valor_contrato", "valor_aditivos",
        "valor_final", "data_inicio", "data_prevista_fim", "data_conclusao", "dias_atraso",
